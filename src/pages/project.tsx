            ...
            <div>
                <div className="project-container">
                    ...
                    <div className="project-items">
                        <h4>Food Delivery <Image src={newImage} alt="image not found" width={70} height={50} /></h4>
                        <Image src={project5} alt="image not found" width={150} height={100} />
                        <p className="pt-3">
                            <b>Description:</b>
                    ...
                    <div className="project-items">
                        <h4>Fitness App </h4>
                        <Image src={project4} alt="image not found" width={150} height={100} />
                        <p className="pt-3">
                            <b>Description:</b>
                    ...
                    <div className="project-items">
                        ...
                        <Image src={project7} alt="image not found" width={150} height={100} />
                        <p className="pt-3">
                            <b>Description:</b>
                    ...
                    <div className="project-items">
                        ...
                        <Image src={project6} alt="image not found" width={150} height={100} />
                        <p className="pt-3">
                            <b>Description:</b>
                    ...
                    <div className="project-items">
                        <h4>Weather-App</h4>
                        <Image src={project3} alt="image not found" width={150} height={100} />
                        <p className="pt-3">
                            <b>Description:</b>
                    ...
                    <div className="project-items">
                        ...
                        <Image src={project2} alt="image not found" width={150} height={100} />
                        <p className="pt-3">
                            <b>Description:</b>
                    ...
                    <div className="project-items">
                        ...
                        <Image src={project1} alt="image not found" width={150} height={100} />
                        <p className="pt-3">
                            <b>Description:</b>
